...
public class GenericDAO {
    ...
    // Execute an update
    public static void executeUpdate(String sql, Object object, Connection connection) throws Exception {
        PreparedStatement statement = null;
        try {
            statement = connection.prepareStatement(sql);
            if (sql.contains("?")) {
                GenericQuery.setStatementValue(statement, object, true);
            }
    ...
    public static <T extends Object> List executeQuery(String sql, Object object, Connection connection) throws Exception {
        ...
        try {
            statement = connection.prepareStatement(sql);
            if (sql.contains("?")) {
                GenericQuery.setStatementValue(statement, object, false);
            }
...
/// Fonctions principale
    ...
    public static void updateById(Object object, Object id, Connection connection) throws Exception {
        ...
        try {
            ...
            GenericDAO.executeUpdate(sql, object, connection);
    ...
    public static void deleteById(Class objectClass, Object id, Connection connection) throws Exception {
        ...
        try {
            ...
            errorDisplay = sql;
            GenericDAO.executeUpdate(sql, null, connection);
